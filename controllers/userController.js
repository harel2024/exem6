...
export const getStudentGrade = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        // מחפש את המשתמש על פי תעודת הזהות (passportId)
        const user = yield userModel.findOne({ passportId: (_a = req.user) === null || _a === void 0 ? void 0 : _a.passportId });
        // אם לא נמצא משתמש
        if (!user) {
...
export const getStudentsAverageGrade = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        // מחפש את המשתמש על פי תעודת הזהות (passportId)
        const user = yield userModel.findOne({ passportId: (_a = req.user) === null || _a === void 0 ? void 0 : _a.passportId });
...
export const getAllGrades = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const studentsWithGrades = yield userModel.aggregate([
            {
...
export const getAverageAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        // בדיקה אם המשתמש הוא מורה
        if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) !== "teacher") {
        ...
        const averageGrade = yield userModel.aggregate([
            {
                $match: { role: "student" } // מסנן רק את המשתמשים שהם תלמידים
            },
            {
...
export const addGrade = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updateGrade = yield userModel.findOneAndUpdate({ passportId: passportId }, { $push: { grades: { subject: subject, score: score } } }, { new: true });
        if (!updateGrade) {
            res.status(404).json({ message: 'User not found' });
            return;
        }
...
export const deleteGrade = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updateGrade = yield userModel.findOneAndUpdate({ passportId: passportId }, { $pull: { grades: { subject: subject } } }, { new: true });
        if (!updateGrade) {
            res.status(404).json({ message: 'User not found' });
            return;
        }
...
//עדכון ציון לתלמיד
export const updateGrade = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        // בדיקה אם המשתמש הוא מורה
        if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) !== "teacher") {
        ...
        const updateGrade = yield userModel.findOneAndUpdate({ passportId: passportId }, { $set: { grades: { subject: subject, score: score } } }, { new: true });
        if (!updateGrade) {
            res.status(404).json({ message: 'User not found' });
            return;
        }
